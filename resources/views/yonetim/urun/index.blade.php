...
@section('content')
    ...
    <h3 class="sub-header">Harytlaryň Sanawy</h3>
    <div class="well">
        <div class="btn-group pull-right" >
            <a href="{{ route('yonetim.urun.yeni') }}" class="btn btn-primary">Täze</a>
        </div>
        <form method="post" action="{{ route('yonetim.urun') }}"  class="form-inline">
            ...
            <a href="{{route('yonetim.urun')}}" class="btn btn-primary">Arassala</a>
        </form>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered">
            ...
            <tbody>
            @if(count($list)== 0)
                <tr><td colspan="7" class="text-center">Haryt tapylmady!</td></tr>
            @endif
 ...
 'http://via.placeholder.com/120x120?text=UrunResmi' }}" style="width: 120px;">
                </td>
                <td>{{ $entry->slug }}</td>
