<div class="list-group">
    ...
    <a href="#" class="list-group-item">
        <span class="fa fa-fw fa-comment"></span> Ürün Yorumlar
        <span class="badge badge-dark badge-pill pull-right">14</span>
    </a>
    <a href="#" class="list-group-item collapsed" data-target="#submenu1" data-toggle="collapse"
       data-parent="#sidebar"><span class="fa fa-fw fa-folder"></span> Kategori Ürünleri <span class="caret arrow"></span></a>
    ...
    <a href="#" class="list-group-item collapsed" data-target="#submenu2" data-toggle="collapse"
       data-parent="#sidebar"><span class="fa fa-fw fa-percent"></span> Raporlar <span class="caret arrow"></span></a>
    ...
    <a href="#" class="list-group-item">
        <span class="fa fa-fw fa-adjust "></span> Site Ayarlar
        <span class="badge badge-dark badge-pill pull-right">14</span>
    </a>
</div>
